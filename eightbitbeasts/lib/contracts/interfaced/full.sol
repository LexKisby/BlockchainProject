...
contract MotherSetter is MotherGetter {
    ...
    function depositCurrency(int256 _quantity, address _address, uint8 _type)
        external
        isTrusted()
    {
...
contract Fusion is Owner {
    ...
    function BeastFusionSwitch(
        ...
        MotherCore.Beast memory primaryBeast = MotherContract.getBeast(_primaryId);
        MotherSetter.Beast memory secondaryBeast = MotherContract.getBeast(_secondaryId);
